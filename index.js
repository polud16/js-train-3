...
function stringToNumber(str) {
  const a = Number(str); // Використовуємо Number() для перетворення рядка в число
  return a; // Повертаємо отримане число
}
...
function convertToFixed(num, precision) {
  return num.toFixed(2); // Використовуємо метод toFixed(), щоб конвертувати число в рядок з фіксованою кількістю знаків після коми
}
...
function convertToPrecision(num, precision) {
  return num.toPrecision(2); // Використовуємо метод toPrecision(), щоб округлити число до вказаної довжини
}
